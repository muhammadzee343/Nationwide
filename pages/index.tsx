...
export default function Home() {
  ...
  return (
    <div className="ml-auto mr-auto">
      ...
      <div className="bg-home_bg_image bg-no-repeat bg-cover bg-right-bottom w-full ">
        <div className="w-full lg:min-h-[700px] bg-[#2131484d] py-[60px] flex flex-wrap justify-around">
          <div
            className=" w-full lg:min-[970px] xl:min-w-[1170px] xl:max-w-[1170px] flex flex-col-reverse flex-col
           items-center lg:items-start lg:flex-row flex-wrap lg:justify-around"
          >
            <div className=" w-[95%] lg:w-[64.5%] xl:w-[62.4%]">
              <HomeTab />
            </div>
            <div className="w-[95%] lg:w-[31.5%] xl:w-[30.7%] ">
              <SelectProperty />
            </div>
          </div>
        </div>
      </div>
      <div className="w-full lg:min-[970px] xl:min-w-[1170px] xl:max-w-[1170px] mx-auto">
      ...
      <section>
        <div className="bg-lime w-full flex justify-center">
          <div className="w-full lg:min-[970px] xl:min-w-[1170px] xl:max-w-[1170px] mx-auto px-3">
            <div className="w-full flex flex-col flex-wrap pt-[80px] pb-[60px]">
