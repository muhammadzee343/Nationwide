...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="w-full bg-white lg:min-h-[530px] pt-[40px] lg:px-[29px] xl:px-[39px] flex flex-wrap justify-center lg:justify-between lg:mb-2">
      ...
      <div className="w-[95%] py-5 lg:min-[970px] xl:min-w-[1170px] xl:max-w-[1170px] mx-auto ">
        <div className="pb-[60px] flex gap-6 flex-col flex-col-reverse lg:flex-row">
          <>
            {content.image && (
              <BoxBackgroundComponent className={'h-[300px] w-[95%] lg:w-5/12 p-2 lg:h-auto'}
                                      greyStyle='w-[15%] h-[50%] top-[0] right-[0] '
                                      limeStyle='w-[15%] h-[90.5%] top-[5%] -right-[5%]'
                                      contentStyle='m-auto p-4'>
                <Image
      ...
      <div className="relative w-full">
        <div className="relative w-full flex flex-row justify-center">
          ...
          <div className="flex justify-center content-container-homepage ">
