...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <div className=" lg:min-h-[680px] py-[60px] bg-home_bg_image bg-no-repeat bg-cover w-full flex flex-wrap justify-evenly">
        <div className=" xl:min-w-[1320px] max-w-[1320px] flex flex-wrap justify-evenly">
