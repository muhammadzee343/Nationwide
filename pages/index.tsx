...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="w-full xl:w-full xxl:max-w-[1440px] mx-auto bg-white lg:min-h-[530px] px-[39px] pt-[40px]  flex flex-wrap justify-center lg:justify-between lg:mb-2">
      ...
      <div className="w-[90%] py-5 lg:min-[970px] xl:min-w-[1170px] xl:max-w-[1170px] mx-auto">
