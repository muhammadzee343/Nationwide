...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="w-full xl:w-full xxl:max-w-[1409px] mx-auto bg-white lg:min-h-[530px] px-[39px] pt-[40px]  flex flex-wrap justify-center lg:justify-between lg:mb-2">
