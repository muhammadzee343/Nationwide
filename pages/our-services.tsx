  ...
  return (
      <div className="ml-auto mr-auto">
          ...
          <div className="bg-home_bg_image bg-cover w-full">
              <div className="flex w-full bg-[#182333]/40 backdrop-brightness-75 pt-[45px] pb-[30px] lg:min-h-[50px] flex flex-row flex-wrap justify-around">
                  <div className="w-full lg:mt-10 lg:w-[35.5%] xl:w-[35.7%]">
          ...
          <div className="w-full py-5 lg:min-[970px] xl:min-w-[1170px] xl:max-w-[1170px] mx-auto">
              {/*SERVICE INFO*/}
              <section>
                  <div className='border-b-4 border-lime w-[110px] mb-3'></div>
                  <h2 className="text-dark-blue text-4xl font-medium">
                      All Our Services
                  </h2>
                  <div className={'h-full w-4 border-slate-900 border-l-2 bg-red-100'}></div>
