    ...
    <div className="w-full bg-white flex justify-center">
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col xl:max-w-[1114px] pt-[65px] pb-[40px] px-3 xl:px-0 font-opensans">
          <h1 className={`text-4xl ${styles.footerPagesHeading}`}>1. Place Order Online</h1>
          <br />
          ...
          <br />
          <h1 className={`${styles.footerPagesHeading}`}>2. Assessment Survey Booked</h1>
          <br />
          <p className={`${styles.footerParagraph}`}>
          ...
          <br />
          <h1 className={`${styles.footerPagesHeading}`}>3. Certificates Issued</h1>
          <br />
          <p className={`${styles.footerParagraph}`}>
