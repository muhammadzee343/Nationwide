        ...
        <div className="w-full bg-white flex justify-center">
            <div className="w-full flex flex-col items-center">
                ...
                <div className='w-full flex flex-col xl:max-w-[1114px] pt-[65px] pb-[40px] px-3 xl:px-0'>
                    ...
                    <br />
                    <p className='footer-paragraph'>Once you placed order online, our planning team will get in touch with you to arrange a suitable date and time to carry out the assessment
                         survey for each service ordered, according to your suitability.</p>
                    <br />
                    <h1 className='footerPagesHeading'>3. Certificates Issued</h1>
                    <br />
                    <p className='footer-paragraph'>Certificates will be issued digitally for each service ordered and sent to you by email, within 48 hours of Assessor’s visit. Being an 
                        online customer, you will also be able to download your certificates from your online account with us.</p>
                    <br />
                </div>
            </div>
        </div>
